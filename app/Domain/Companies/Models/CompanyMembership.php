...
class CompanyMembership extends Model
{
    ...
    protected $fillable = ['organization_id', 'company_id', 'user_id', 'is_primary'];
    ...
    protected static function newFactory(): CompanyMembershipFactory
    {
        return CompanyMembershipFactory::new();
    }
}
