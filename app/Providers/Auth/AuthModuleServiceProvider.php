...
class AuthModuleServiceProvider extends ServiceProvider
{
    ...
    private function pushSharedMiddleware(): void
    {
        ...
        // middleware resolves organization-scoped route models. Appending
        // these middleware puts them after binding and makes every
        // /resource/{tenantModel} route fail closed with a false 404.
        $kernel->prependMiddlewareToGroup('web', AssignRequestId::class);
        $kernel->prependMiddlewareToGroup('web', SetCurrentOrganization::class);
